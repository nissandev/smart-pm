...
export function ProjectExpensesPanel({
  ...
  return (
    <div className={embedded ? 'space-y-4' : 'card p-5 mb-4'}>
      <div className={`flex items-center justify-between gap-3 flex-wrap ${embedded ? '' : 'mb-4'}`}>
        {!embedded ? (
        ...
        {canManage && (
          <button
            type="button"
            className="btn-primary text-xs py-1.5 inline-flex items-center gap-1 flex-shrink-0"
